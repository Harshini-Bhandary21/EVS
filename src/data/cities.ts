...
export interface EnvironmentalMetrics {
  ...
  ozone: number;
  noise: number;
  waterConsumption: number; // liters/capita/day
  greenCover: number; // percentage
  carbonEmissions: number; // million tonnes CO2e/year
  carbonAbsorbed: number; // million tonnes CO2e/year
  renewableEnergy: number; // percentage
  wasteEfficiency: number; // percentage
